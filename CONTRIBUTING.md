...
These are the main contributing guidelines for this project. The development structure for this is based on open participation, where anyone can contribute using the standard processes on GitHub.

Feedback and contributions of any form are welcomed. Feel free also to [contact me](jane.frazier@example.com) to discuss anything further.
